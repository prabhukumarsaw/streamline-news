...
export function AuthorDashboard() {
  ...
  const { authorData, selectedDateRange, isLoading, error } = useAppSelector(state => state.dashboard);
        ...
        <Card>
          <CardContent className="flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <Button onClick={() => dispatch(fetchAuthorDashboard(selectedDateRange))}>
                Retry
              </Button>
            </div>
          </CardContent>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{authorData.totalViews.toLocaleString()}</div>
            <p className="text-xs text-muted-foreground">
              Across all articles
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{authorData.averageRating.toFixed(1)}</div>
            <p className="text-xs text-muted-foreground">
              Out of 5.0 stars
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{authorData.recentComments}</div>
            <p className="text-xs text-muted-foreground">
              Comments this week
            </p>
          </CardContent>
