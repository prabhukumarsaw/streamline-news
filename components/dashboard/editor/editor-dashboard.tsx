...
export function EditorDashboard() {
  ...
  const { editorData, selectedDateRange, isLoading, error } = useAppSelector(state => state.dashboard);
        ...
        <Card>
          <CardContent className="flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <Button onClick={() => dispatch(fetchEditorDashboard(selectedDateRange))}>
                Retry
              </Button>
            </div>
          </CardContent>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{editorData.assignedArticles}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{editorData.pendingReviews}</div>
            <p className="text-xs text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{editorData.publishedToday}</div>
            <p className="text-xs text-muted-foreground">
